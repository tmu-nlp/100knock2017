...
def logistic_train(polarity_lines):
    dat = list()
    dat_t = list()
    count = 0
    eta = 0.01 
...
if __name__ == "__main__":
    ...
    for num in range(5):
        ...
        logistic_train(polarity_file[0:seg_num * num] + polarity_file[seg_num * num:])
        pickle.dump(logi_reg.weights, open('weight' + str(num) + '.pkl', 'wb') )
